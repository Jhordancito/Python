...
#print(lista.count(4)) cuantos veces se repite en la lista
#lista.pop(5) Eliminar el numero indicado de la Lista
#lista.remove("Martes") remueve el nombre indicado
#lista.reverse() vuelca todos los elementos
#lista.sort() ordena acendente
